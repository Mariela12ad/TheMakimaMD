...
let bienvenida
//agregado = `*🤖 Ha llegado un nuevo participante al grupo.*\n\n*◦ 💓 Grupo:* ${groupMetadata.subject}\n\n*◦ 🥳 Bienvenido/a:* @${m.messageStubParameters[0].split('@')[0]} ingresado al grupo\n\n*◦ ❤️ Añadido por:* @${m.sender.split('@')[0]} que añadió a @${m.messageStubParameters[0].split('@')[0]} al grupo`
bienvenida = `*🤖 Ha llegado un nuevo participante al grupo.*\n\n*◦ 💓 Grupo:* ${groupMetadata.subject}\n\n*◦ 🥳 Bienvenido/a:* @${m.messageStubParameters[0].split('@')[0]} ingresado al grupo\n\n*◦ ❤️ Aceptado por:* @${m.sender.split('@')[0]} que aceptó la solicitud de @${m.messageStubParameters[0].split('@')[0]} a ingresar al grupo`    
